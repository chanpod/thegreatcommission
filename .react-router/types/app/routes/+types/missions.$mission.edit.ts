...
// routes/missions.$mission.edit.tsx
...
type Module = typeof import("../missions.$mission.edit.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/missions.$mission.edit"
  file: "routes/missions.$mission.edit.tsx"
  path: "edit"
