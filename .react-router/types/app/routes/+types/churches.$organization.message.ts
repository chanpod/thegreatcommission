...
// routes/churches.$organization.message.tsx
...
type Module = typeof import("../churches.$organization.message.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/churches.$organization.message"
  file: "routes/churches.$organization.message.tsx"
  path: "message"
