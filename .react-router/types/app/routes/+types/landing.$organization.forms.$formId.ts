...
// routes/landing.$organization.forms.$formId.tsx
...
type Module = typeof import("../landing.$organization.forms.$formId.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/landing.$organization.forms.$formId"
  file: "routes/landing.$organization.forms.$formId.tsx"
  path: ":formId"
