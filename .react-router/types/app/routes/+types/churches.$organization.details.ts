...
// routes/churches.$organization.details.tsx
...
type Module = typeof import("../churches.$organization.details.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/churches.$organization.details"
  file: "routes/churches.$organization.details.tsx"
  path: "details"
