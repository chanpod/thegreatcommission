...
// routes/churches.$organization.request.tsx
...
type Module = typeof import("../churches.$organization.request.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/churches.$organization.request"
  file: "routes/churches.$organization.request.tsx"
  path: "request"
