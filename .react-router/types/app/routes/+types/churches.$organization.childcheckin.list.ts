...
// routes/churches.$organization.childcheckin.list.tsx
...
type Module = typeof import("../churches.$organization.childcheckin.list.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2, Parent3],
  id: "routes/churches.$organization.childcheckin.list"
  file: "routes/churches.$organization.childcheckin.list.tsx"
  path: "list"
