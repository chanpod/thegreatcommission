...
export const action = async ({ request, params }) => {
    ...
    if (request.method === "POST") {
        ...
        if (existingUser.users) {
            ...
            const response = await db.insert(usersTochurchOrganization).values({
    ...
    if (request.method === "DELETE") {
        ...
        const response = await db.delete(usersTochurchOrganization).where(eq(usersTochurchOrganization.userId, params.userId));
        return {
            success: true,
        };
    }
