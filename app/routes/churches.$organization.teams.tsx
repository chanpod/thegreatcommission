...
export const loader = async ({ params }) => {
    ...
    const teamsWithMembers = teamsList.reduce((acc, curr) => {
        ...
        if (existingTeam) {
            if (curr.members) {
                existingTeam.members.push(curr.members);
            }
            return acc;
        }
        acc.push({
        ...
        return acc;
    }, [] as Array<{ team: typeof teamsTable.$inferSelect, members: typeof usersToTeams.$inferSelect[] }>);
...
export default function TeamsList() {
    ...
    const [selectedTeam, setSelectedTeam] = useState<typeof teamsTable.$inferSelect | null>(null);
            ...
            <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
                <DialogContent>
                    ...
                    <form method="post" className="space-y-4">
                        <input type="hidden" name="_action" value={selectedTeam ? "update" : "create"} />
                        {selectedTeam && (
