...
import { Home, PersonStanding, LandPlot } from 'lucide-react'
const TailSpin = React.lazy(() => import('react-loader-spinner').then(module => ({ default: module.TailSpin })));


export const navigation = [
    { icon: Home, label: 'Churches', href: '/churches' },
    { icon: PersonStanding, label: 'Missionaries', href: '/missionaries' },
    { icon: LandPlot, label: 'Missions', href: '/missions' },
];
